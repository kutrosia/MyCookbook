...
public class ShoppingListIngredientViewModel extends ViewModel {

    private ShoppingListLocalRepository shoppingListLocalRepository;

    public ShoppingListIngredientViewModel(ShoppingListLocalRepository shoppingListLocalRepository) {
