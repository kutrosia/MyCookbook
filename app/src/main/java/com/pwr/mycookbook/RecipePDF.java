...
public class RecipePDF {
    ...
    public File writeRecipeToPDF(Recipe recipe, Context context, AppDatabase db){
        ...
        try {
            ...
            List<Recipe_Ingredient> recipe_ingredientList = db.recipe_ingredientDao().getIngredientsForRecipe(recipe.getId());

            for(Recipe_Ingredient recipe_ingredient: recipe_ingredientList){
                Ingredient ingredient = db.ingredientDao().findById(recipe_ingredient.ingredient_id);
                String string_ingredient = ingredient.getName() + " " + recipe_ingredient.getQuantity() + " " + recipe_ingredient.getMeasure();
