...
public class RecipePDF {
    ...
    public File writeRecipeToPDF(Recipe recipe, List<Recipe_Ingredient> recipe_ingredients, List<Ingredient> ingredients, Context context){
        ...
        try {
            ...
            for(Recipe_Ingredient recipe_ingredient: recipe_ingredients){
                for(Ingredient ingredient: ingredients){
                    if(ingredient.getId() == recipe_ingredient.getIngredient_id()){
